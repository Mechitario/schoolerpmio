...
<div class="max-w-xl">
    ...
    <div class="bg-white dark:bg-slate-800/80 border border-gray-200 dark:border-slate-700 rounded-xl shadow-sm dark:shadow-none p-6">
        <h2 class="text-gray-900 dark:text-white mb-4">Add New Staff Member</h2>
        ...
        <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <select name="role" id="role" required
                    ...
                    <option value="Senior Teacher" {{ old('role') === 'Senior Teacher' ? 'selected' : '' }}>Senior Teacher</option>
                    <option value="PE Teacher" {{ old('role') === 'PE Teacher' ? 'selected' : '' }}>PE Teacher</option>
