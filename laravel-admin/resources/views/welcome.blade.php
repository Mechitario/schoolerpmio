...
@section('title', 'EduManage School')
...
<div class="min-h-full">
    ...
    <section id="about" class="mb-16 scroll-mt-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div class="rounded-2xl overflow-hidden border border-gray-200 dark:border-slate-700 bg-gray-100 dark:bg-slate-800 h-80 bg-gradient-to-br from-cyan-100 to-violet-100 dark:from-cyan-900/20 dark:to-violet-900/20"></div>
            <div>
