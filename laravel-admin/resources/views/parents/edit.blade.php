...
@section('breadcrumb', 'Edit Parent')
...
<div class="max-w-xl">
    ...
    <div class="bg-white dark:bg-slate-800/80 border border-gray-200 dark:border-slate-700 rounded-xl shadow-sm dark:shadow-none p-6">
        <h2 class="text-gray-900 dark:text-white mb-4">Edit Parent / Guardian</h2>
        ...
        <form method="POST" action="{{ route('admin.parents.update', $parent) }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $parent->name) }}" required autofocus
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-slate-500">Minimum 6 characters. Leave blank to keep current password unchanged.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="2"
                          class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-700/50 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-900 dark:text-slate-100 placeholder-gray-500 dark:placeholder-slate-500 focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-colors"
                          placeholder="Optional">{{ old('address', $parent->address) }}</textarea>
            </div>
            <div id="student-link-wrapper">
                ...
                @if($students->isEmpty())
                <p class="text-sm text-gray-500 dark:text-slate-500 mt-2">No students in the system yet.</p>
                @endif
            </div>
            <script>
            (function() {
                var data = {
                    ...
                    selectedIds: @json(old('student_ids', $parent->students->pluck('id')->toArray()))
                };
