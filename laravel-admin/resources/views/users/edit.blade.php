...
<div class="max-w-xl">
    ...
    <div class="bg-white dark:bg-slate-800/80 border border-gray-200 dark:border-slate-700 rounded-xl shadow-sm dark:shadow-none p-6">
        <h2 class="text-gray-900 dark:text-white mb-4">Edit User Account</h2>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-slate-500">Only fill if you want to change the password.</p>
            </div>
            <div>
            ...
            <div class="pt-4 border-t border-gray-200 dark:border-slate-700">
                ...
                <div class="space-y-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="can_view_dashboard" value="1" {{ old('can_view_dashboard', $user->can_view_dashboard) ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="can_view_admin_users" value="1" {{ old('can_view_admin_users', $user->can_view_admin_users) ? 'checked' : '' }}
                               class="w-4 h-4 rounded border-gray-300 dark:border-slate-600 text-cyan-600 focus:ring-cyan-500/50">
                        <span class="text-gray-700 dark:text-slate-300">Admin users management</span>
                    </label>
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="can_view_students" value="1" {{ old('can_view_students', $user->can_view_students) ? 'checked' : '' }}
                               class="w-4 h-4 rounded border-gray-300 dark:border-slate-600 text-cyan-600 focus:ring-cyan-500/50">
